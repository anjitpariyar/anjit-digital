...
/** Connection between the CourseId_Fields type and the MediaItem type */
...
/** The &quot;CourseId&quot; Field Group. Added to the Schema by &quot;WPGraphQL for ACF&quot;. */
export type CourseId = AcfFieldGroup & AcfFieldGroupFields & CourseId_Fields & {
  __typename?: 'CourseId';
  /** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;CourseId&quot; Field Group */
   ...
   */
  fieldGroupName?: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;image&quot; Field Type added to the schema as part of the &quot;CourseId&quot; Field Group */
  image?: Maybe<AcfMediaItemConnectionEdge>;
  /** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;CourseId&quot; Field Group */
  title?: Maybe<Scalars['String']['output']>;
};

/** Interface representing fields of the ACF &quot;CourseId&quot; Field Group */
export type CourseId_Fields = {
  /** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;CourseId&quot; Field Group */
  description: Scalars['String']['output'];
  /**
   * The name of the field group
...
export type CreateLessonCategoryInput = {
  /** The slug that the lesson-category will be an alias of */
  aliasOf?: InputMaybe<Scalars['String']['input']>;
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** The description of the lesson-category object */
  description?: InputMaybe<Scalars['String']['input']>;
  /** The name of the lesson-category object to mutate */
  name: Scalars['String']['input'];
  /** If this argument exists then the slug will be checked to see if it is not an existing valid term. If that check succeeds (it is not a valid term), then it is added and the term id is given. If it fails, then a check is made to whether the taxonomy is hierarchical and the parent argument is not empty. If the second check succeeds, the term will be inserted and the term id will be given. If the slug argument is empty, then it will be calculated from the term name. */
  slug?: InputMaybe<Scalars['String']['input']>;
};
...
/** The lesson type */
export type Lesson = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithFeaturedImage & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & WithAcfCourseId & {
  __typename?: 'Lesson';
  /**
   * The ancestors of the content node.
   * @deprecated This content type is not hierarchical and typically will not have ancestors
   */
  ancestors?: Maybe<LessonToLessonConnection>;
  ...
  /** The name of the Content Type the node belongs to */
  contentTypeName: Scalars['String']['output'];
  /** Fields of the CourseId ACF Field Group */
  ...
  /** The global unique identifier for this post. This currently matches the value stored in WP_Post-&gt;guid and the guid column in the &quot;post_objects&quot; database table. */
  guid?: Maybe<Scalars['String']['output']>;
  /** Whether the lesson object is password protected. */
   ...
   */
  parent?: Maybe<LessonToParentConnectionEdge>;
  /** The password for the lesson object. */
...
/** The lesson type */
export type LessonAncestorsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
export type LessonCategory = DatabaseIdentifier & MenuItemLinkable & Node & TermNode & UniformResourceIdentifiable & {
...
/** A paginated collection of lessonCategory Nodes, Supports cursor-based pagination and filtering to efficiently retrieve sets of lessonCategory Nodes */
export type LessonCategoryConnection = {
  /** A list of edges (relational context) between RootQuery and connected lessonCategory Nodes */
  edges: Array<LessonCategoryConnectionEdge>;
  /** A list of connected lessonCategory Nodes */
  nodes: Array<LessonCategory>;
  /** Information about pagination in a connection. */
  pageInfo: LessonCategoryConnectionPageInfo;
};

/** Represents a connection to a lessonCategory. Contains both the lessonCategory Node and metadata about the relationship. */
export type LessonCategoryConnectionEdge = {
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The connected lessonCategory Node */
  node: LessonCategory;
};

/** Pagination metadata specific to &quot;LessonCategoryConnectionEdge&quot; collections. Provides cursors and flags for navigating through sets of &quot;LessonCategoryConnectionEdge&quot; Nodes. */
export type LessonCategoryConnectionPageInfo = {
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Identifier types for retrieving a specific LessonCategory. Determines which unique property (global ID, database ID, slug, etc.) is used to locate the LessonCategory. */
...
/** Connection between the LessonCategory type and the ContentNode type */
export type LessonCategoryToContentNodeConnection = Connection & ContentNodeConnection & {
  __typename?: 'LessonCategoryToContentNodeConnection';
  /** Edges for the LessonCategoryToContentNodeConnection connection */
  edges: Array<LessonCategoryToContentNodeConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<ContentNode>;
  /** Information about pagination in a connection. */
  pageInfo: LessonCategoryToContentNodeConnectionPageInfo;
};

/** An edge in a connection */
export type LessonCategoryToContentNodeConnectionEdge = ContentNodeConnectionEdge & Edge & {
...
/** Pagination metadata specific to &quot;LessonCategoryToContentNodeConnection&quot; collections. Provides cursors and flags for navigating through sets of LessonCategoryToContentNodeConnection Nodes. */
export type LessonCategoryToContentNodeConnectionPageInfo = ContentNodeConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'LessonCategoryToContentNodeConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Connection between the LessonCategory type and the lesson type */
export type LessonCategoryToLessonConnection = Connection & LessonConnection & {
  __typename?: 'LessonCategoryToLessonConnection';
  /** Edges for the LessonCategoryToLessonConnection connection */
  edges: Array<LessonCategoryToLessonConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Lesson>;
  /** Information about pagination in a connection. */
  pageInfo: LessonCategoryToLessonConnectionPageInfo;
};

/** An edge in a connection */
export type LessonCategoryToLessonConnectionEdge = Edge & LessonConnectionEdge & {
...
/** Pagination metadata specific to &quot;LessonCategoryToLessonConnection&quot; collections. Provides cursors and flags for navigating through sets of LessonCategoryToLessonConnection Nodes. */
export type LessonCategoryToLessonConnectionPageInfo = LessonConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'LessonCategoryToLessonConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Connection between the LessonCategory type and the Taxonomy type */
export type LessonCategoryToTaxonomyConnectionEdge = Edge & OneToOneConnection & TaxonomyConnectionEdge & {
...
/** A paginated collection of lesson Nodes, Supports cursor-based pagination and filtering to efficiently retrieve sets of lesson Nodes */
export type LessonConnection = {
  /** A list of edges (relational context) between RootQuery and connected lesson Nodes */
  edges: Array<LessonConnectionEdge>;
  /** A list of connected lesson Nodes */
  nodes: Array<Lesson>;
  /** Information about pagination in a connection. */
  pageInfo: LessonConnectionPageInfo;
};

/** Represents a connection to a lesson. Contains both the lesson Node and metadata about the relationship. */
export type LessonConnectionEdge = {
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The connected lesson Node */
  node: Lesson;
};

/** Pagination metadata specific to &quot;LessonConnectionEdge&quot; collections. Provides cursors and flags for navigating through sets of &quot;LessonConnectionEdge&quot; Nodes. */
export type LessonConnectionPageInfo = {
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Identifier types for retrieving a specific Lesson. Specifies which unique attribute is used to find an exact Lesson. */
...
/** Connection between the Lesson type and the lessonCategory type */
export type LessonToLessonCategoryConnection = Connection & LessonCategoryConnection & {
  __typename?: 'LessonToLessonCategoryConnection';
  /** Edges for the LessonToLessonCategoryConnection connection */
  edges: Array<LessonToLessonCategoryConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<LessonCategory>;
  /** Information about pagination in a connection. */
  pageInfo: LessonToLessonCategoryConnectionPageInfo;
};

/** An edge in a connection */
export type LessonToLessonCategoryConnectionEdge = Edge & LessonCategoryConnectionEdge & {
...
/** Pagination metadata specific to &quot;LessonToLessonCategoryConnection&quot; collections. Provides cursors and flags for navigating through sets of LessonToLessonCategoryConnection Nodes. */
export type LessonToLessonCategoryConnectionPageInfo = LessonCategoryConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'LessonToLessonCategoryConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Connection between the Lesson type and the lesson type */
export type LessonToLessonConnection = Connection & LessonConnection & {
  __typename?: 'LessonToLessonConnection';
  /** Edges for the LessonToLessonConnection connection */
  edges: Array<LessonToLessonConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Lesson>;
  /** Information about pagination in a connection. */
  pageInfo: LessonToLessonConnectionPageInfo;
};

/** An edge in a connection */
export type LessonToLessonConnectionEdge = Edge & LessonConnectionEdge & {
  __typename?: 'LessonToLessonConnectionEdge';
  /**
   * A cursor for use in pagination
   * @deprecated This content type is not hierarchical and typically will not have ancestors
   */
...
/** Pagination metadata specific to &quot;LessonToLessonConnection&quot; collections. Provides cursors and flags for navigating through sets of LessonToLessonConnection Nodes. */
export type LessonToLessonConnectionPageInfo = LessonConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'LessonToLessonConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Connection between the Lesson type and the lesson type */
export type LessonToParentConnectionEdge = Edge & LessonConnectionEdge & OneToOneConnection & {
  __typename?: 'LessonToParentConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /**
   * The node of the connection, without the edges
...
/** Connection between the Lesson type and the lesson type */
export type LessonToPreviewConnectionEdge = Edge & LessonConnectionEdge & OneToOneConnection & {
...
/** Connection between the Lesson type and the TermNode type */
export type LessonToTermNodeConnection = Connection & TermNodeConnection & {
  __typename?: 'LessonToTermNodeConnection';
  /** Edges for the LessonToTermNodeConnection connection */
  edges: Array<LessonToTermNodeConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<TermNode>;
  /** Information about pagination in a connection. */
  pageInfo: LessonToTermNodeConnectionPageInfo;
};

/** An edge in a connection */
export type LessonToTermNodeConnectionEdge = Edge & TermNodeConnectionEdge & {
...
/** Pagination metadata specific to &quot;LessonToTermNodeConnection&quot; collections. Provides cursors and flags for navigating through sets of LessonToTermNodeConnection Nodes. */
export type LessonToTermNodeConnectionPageInfo = PageInfo & TermNodeConnectionPageInfo & WpPageInfo & {
  __typename?: 'LessonToTermNodeConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
export type MenuItemObjectUnion = Category | Lesson | LessonCategory | Page | Post | PostFormat | Tag;
...
export type Page = ContentNode & DatabaseIdentifier & HierarchicalContentNode & HierarchicalNode & MenuItemLinkable & Node & NodeWithAuthor & NodeWithComments & NodeWithContentEditor & NodeWithFeaturedImage & NodeWithPageAttributes & NodeWithRevisions & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & WithAcfPageComponents & {
  __typename?: 'Page';
  /** Returns ancestors of the node. Default ordered as lowest (closest to the child) to highest (closest to the root). */
  ancestors?: Maybe<HierarchicalContentNodeToContentNodeAncestorsConnection>;
  /** Connection between the NodeWithAuthor type and the User type */
  ...
  /** The GMT modified time for a post. If a post was recently updated the modified field will change to match the corresponding time in GMT. */
  modifiedGmt?: Maybe<Scalars['String']['output']>;
  /** Fields of the PageComponents ACF Field Group */
  pageComponents?: Maybe<PageComponents>;
  /**
   * The id field matches the WP_Post-&gt;ID field.
   * @deprecated Deprecated in favor of the databaseId field
   */
...
/** The &quot;PageComponentCloneFields&quot; Field Group. Added to the Schema by &quot;WPGraphQL for ACF&quot;. */
export type PageComponentCloneFields = AcfFieldGroup & AcfFieldGroupFields & PageComponentCloneFields_Fields & {
  __typename?: 'PageComponentCloneFields';
  /** Field of the &quot;group&quot; Field Type added to the schema as part of the &quot;PageComponentCloneFields&quot; Field Group */
  bannerHomepage?: Maybe<PageComponentCloneFieldsBannerHomepage>;
  /**
   * The name of the field group
   * @deprecated Use __typename instead
   */
  fieldGroupName?: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;group&quot; Field Type added to the schema as part of the &quot;PageComponentCloneFields&quot; Field Group */
  lesson?: Maybe<PageComponentCloneFieldsLesson>;
};

/** The &quot;PageComponentCloneFieldsBannerHomepage&quot; Field Group. Added to the Schema by &quot;WPGraphQL for ACF&quot;. */
export type PageComponentCloneFieldsBannerHomepage = AcfFieldGroup & AcfFieldGroupFields & PageComponentCloneFieldsBannerHomepage_Fields & {
  __typename?: 'PageComponentCloneFieldsBannerHomepage';
  /** Field of the &quot;group&quot; Field Type added to the schema as part of the &quot;PageComponentCloneFieldsBannerHomepage&quot; Field Group */
  button?: Maybe<PageComponentCloneFieldsBannerHomepageButton>;
  /** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;PageComponentCloneFieldsBannerHomepage&quot; Field Group */
  description?: Maybe<Scalars['String']['output']>;
  /**
   * The name of the field group
   * @deprecated Use __typename instead
   */
  fieldGroupName?: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;image&quot; Field Type added to the schema as part of the &quot;PageComponentCloneFieldsBannerHomepage&quot; Field Group */
  image?: Maybe<AcfMediaItemConnectionEdge>;
  /** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;PageComponentCloneFieldsBannerHomepage&quot; Field Group */
  title?: Maybe<Scalars['String']['output']>;
};

/** The &quot;PageComponentCloneFieldsBannerHomepageButton&quot; Field Group. Added to the Schema by &quot;WPGraphQL for ACF&quot;. */
export type PageComponentCloneFieldsBannerHomepageButton = AcfFieldGroup & AcfFieldGroupFields & PageComponentCloneFieldsBannerHomepageButton_Fields & {
  __typename?: 'PageComponentCloneFieldsBannerHomepageButton';
  /**
   * The name of the field group
   * @deprecated Use __typename instead
   */
  fieldGroupName?: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;PageComponentCloneFieldsBannerHomepageButton&quot; Field Group */
  label?: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;PageComponentCloneFieldsBannerHomepageButton&quot; Field Group */
  link?: Maybe<Scalars['String']['output']>;
};

/** Interface representing fields of the ACF &quot;PageComponentCloneFieldsBannerHomepageButton&quot; Field Group */
export type PageComponentCloneFieldsBannerHomepageButton_Fields = {
  /**
   * The name of the field group
   * @deprecated Use __typename instead
   */
...
/** Interface representing fields of the ACF &quot;PageComponentCloneFieldsBannerHomepage&quot; Field Group */
export type PageComponentCloneFieldsBannerHomepage_Fields = {
  /** Field of the &quot;group&quot; Field Type added to the schema as part of the &quot;PageComponentCloneFieldsBannerHomepage&quot; Field Group */
  button?: Maybe<PageComponentCloneFieldsBannerHomepageButton>;
  /** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;PageComponentCloneFieldsBannerHomepage&quot; Field Group */
  description?: Maybe<Scalars['String']['output']>;
...
/** The &quot;PageComponentCloneFieldsLesson&quot; Field Group. Added to the Schema by &quot;WPGraphQL for ACF&quot;. */
export type PageComponentCloneFieldsLesson = AcfFieldGroup & AcfFieldGroupFields & PageComponentCloneFieldsLesson_Fields & {
  __typename?: 'PageComponentCloneFieldsLesson';
  /** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;PageComponentCloneFieldsLesson&quot; Field Group */
  description?: Maybe<Scalars['String']['output']>;
  /**
   * The name of the field group
   * @deprecated Use __typename instead
...
/** Interface representing fields of the ACF &quot;PageComponentCloneFieldsLesson&quot; Field Group */
export type PageComponentCloneFieldsLesson_Fields = {
  /** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;PageComponentCloneFieldsLesson&quot; Field Group */
  description?: Maybe<Scalars['String']['output']>;
  /**
   * The name of the field group
...
/** Interface representing fields of the ACF &quot;PageComponentCloneFields&quot; Field Group */
export type PageComponentCloneFields_Fields = {
  /** Field of the &quot;group&quot; Field Type added to the schema as part of the &quot;PageComponentCloneFields&quot; Field Group */
  bannerHomepage?: Maybe<PageComponentCloneFieldsBannerHomepage>;
  /**
   * The name of the field group
...
/** The &quot;PageComponents&quot; Field Group. Added to the Schema by &quot;WPGraphQL for ACF&quot;. */
export type PageComponents = AcfFieldGroup & AcfFieldGroupFields & PageComponents_Fields & {
  __typename?: 'PageComponents';
  /**
   * The name of the field group
   * @deprecated Use __typename instead
   */
  fieldGroupName?: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;flexible_content&quot; Field Type added to the schema as part of the &quot;PageComponents&quot; Field Group */
  pageComponents?: Maybe<Array<Maybe<PageComponentsPageComponents_Layout>>>;
};

/** The &quot;PageComponentsPageComponentsBannerHomepage&quot; Field Group. Added to the Schema by &quot;WPGraphQL for ACF&quot;. */
export type PageComponentsPageComponentsBannerHomepage = AcfFieldGroup & AcfFieldGroupFields & PageComponentsPageComponentsBannerHomepage_Fields & {
  __typename?: 'PageComponentsPageComponentsBannerHomepage';
  /** Field of the &quot;group&quot; Field Type added to the schema as part of the &quot;PageComponentsPageComponentsBannerHomepage&quot; Field Group */
  button?: Maybe<PageComponentCloneFieldsBannerHomepageButton>;
  /** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;PageComponentsPageComponentsBannerHomepage&quot; Field Group */
  description?: Maybe<Scalars['String']['output']>;
  /**
   * The name of the field group
   * @deprecated Use __typename instead
   */
  fieldGroupName?: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;image&quot; Field Type added to the schema as part of the &quot;PageComponentsPageComponentsBannerHomepage&quot; Field Group */
  image?: Maybe<AcfMediaItemConnectionEdge>;
  /** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;PageComponentsPageComponentsBannerHomepage&quot; Field Group */
  title?: Maybe<Scalars['String']['output']>;
};

/** The &quot;PageComponentsPageComponentsBannerHomepageLayout&quot; Field Group. Added to the Schema by &quot;WPGraphQL for ACF&quot;. */
export type PageComponentsPageComponentsBannerHomepageLayout = AcfFieldGroup & AcfFieldGroupFields & PageComponentsPageComponentsBannerHomepageLayout_Fields & PageComponentsPageComponents_Layout & {
  __typename?: 'PageComponentsPageComponentsBannerHomepageLayout';
  /** Field of the &quot;group&quot; Field Type added to the schema as part of the &quot;PageComponentsPageComponentsBannerHomepageLayout&quot; Field Group */
  bannerHomepage?: Maybe<PageComponentsPageComponentsBannerHomepage>;
  /**
   * The name of the field group
   * @deprecated Use __typename instead
   */
...
/** Interface representing fields of the ACF &quot;PageComponentsPageComponentsBannerHomepageLayout&quot; Field Group */
export type PageComponentsPageComponentsBannerHomepageLayout_Fields = {
  /** Field of the &quot;group&quot; Field Type added to the schema as part of the &quot;PageComponentsPageComponentsBannerHomepageLayout&quot; Field Group */
  bannerHomepage?: Maybe<PageComponentsPageComponentsBannerHomepage>;
  /**
   * The name of the field group
...
/** Interface representing fields of the ACF &quot;PageComponentsPageComponentsBannerHomepage&quot; Field Group */
export type PageComponentsPageComponentsBannerHomepage_Fields = {
  /** Field of the &quot;group&quot; Field Type added to the schema as part of the &quot;PageComponentsPageComponentsBannerHomepage&quot; Field Group */
  button?: Maybe<PageComponentCloneFieldsBannerHomepageButton>;
  /** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;PageComponentsPageComponentsBannerHomepage&quot; Field Group */
  description?: Maybe<Scalars['String']['output']>;
...
/** The &quot;PageComponentsPageComponentsLesson&quot; Field Group. Added to the Schema by &quot;WPGraphQL for ACF&quot;. */
export type PageComponentsPageComponentsLesson = AcfFieldGroup & AcfFieldGroupFields & PageComponentsPageComponentsLesson_Fields & {
  __typename?: 'PageComponentsPageComponentsLesson';
  /** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;PageComponentsPageComponentsLesson&quot; Field Group */
  description?: Maybe<Scalars['String']['output']>;
  /**
   * The name of the field group
   * @deprecated Use __typename instead
...
/** The &quot;PageComponentsPageComponentsLessonSectionLayout&quot; Field Group. Added to the Schema by &quot;WPGraphQL for ACF&quot;. */
export type PageComponentsPageComponentsLessonSectionLayout = AcfFieldGroup & AcfFieldGroupFields & PageComponentsPageComponentsLessonSectionLayout_Fields & PageComponentsPageComponents_Layout & {
  __typename?: 'PageComponentsPageComponentsLessonSectionLayout';
  /**
   * The name of the field group
   * @deprecated Use __typename instead
   */
  fieldGroupName?: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;group&quot; Field Type added to the schema as part of the &quot;PageComponentsPageComponentsLessonSectionLayout&quot; Field Group */
  lesson?: Maybe<PageComponentsPageComponentsLesson>;
};

/** Interface representing fields of the ACF &quot;PageComponentsPageComponentsLessonSectionLayout&quot; Field Group */
export type PageComponentsPageComponentsLessonSectionLayout_Fields = {
  /**
   * The name of the field group
   * @deprecated Use __typename instead
   */
...
/** Interface representing fields of the ACF &quot;PageComponentsPageComponentsLesson&quot; Field Group */
export type PageComponentsPageComponentsLesson_Fields = {
  /** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;PageComponentsPageComponentsLesson&quot; Field Group */
  description?: Maybe<Scalars['String']['output']>;
  /**
   * The name of the field group
...
/** Layout of the &quot;pageComponents&quot; Field of the &quot;PageComponents&quot; Field Group Field */
export type PageComponentsPageComponents_Layout = {
  /** The name of the ACF Flex Field Layout */
  fieldGroupName?: Maybe<Scalars['String']['output']>;
};

/** Interface representing fields of the ACF &quot;PageComponents&quot; Field Group */
export type PageComponents_Fields = {
  /**
   * The name of the field group
   * @deprecated Use __typename instead
   */
...
export type Post = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithAuthor & NodeWithComments & NodeWithContentEditor & NodeWithExcerpt & NodeWithFeaturedImage & NodeWithRevisions & NodeWithTemplate & NodeWithTitle & NodeWithTrackbacks & Previewable & UniformResourceIdentifiable & WithAcfCourseId & {
  __typename?: 'Post';
  /**
   * The ancestors of the content node.
   * @deprecated This content type is not hierarchical and typically will not have ancestors
...
export type RootMutation = {
  ...
  /** The createLesson mutation */
  createLesson?: Maybe<CreateLessonPayload>;
  /** The createLessonCategory mutation */
  ...
  /** The deleteLesson mutation */
  deleteLesson?: Maybe<DeleteLessonPayload>;
  /** The deleteLessonCategory mutation */
  ...
  /** The updateLesson mutation */
  updateLesson?: Maybe<UpdateLessonPayload>;
  /** The updateLessonCategory mutation */
...
/** Connection between the RootQuery type and the lessonCategory type */
export type RootQueryToLessonCategoryConnection = Connection & LessonCategoryConnection & {
  __typename?: 'RootQueryToLessonCategoryConnection';
  /** Edges for the RootQueryToLessonCategoryConnection connection */
  edges: Array<RootQueryToLessonCategoryConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<LessonCategory>;
  /** Information about pagination in a connection. */
  pageInfo: RootQueryToLessonCategoryConnectionPageInfo;
};

/** An edge in a connection */
export type RootQueryToLessonCategoryConnectionEdge = Edge & LessonCategoryConnectionEdge & {
...
/** Pagination metadata specific to &quot;RootQueryToLessonCategoryConnection&quot; collections. Provides cursors and flags for navigating through sets of RootQueryToLessonCategoryConnection Nodes. */
export type RootQueryToLessonCategoryConnectionPageInfo = LessonCategoryConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'RootQueryToLessonCategoryConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Connection between the RootQuery type and the lesson type */
export type RootQueryToLessonConnection = Connection & LessonConnection & {
  __typename?: 'RootQueryToLessonConnection';
  /** Edges for the RootQueryToLessonConnection connection */
  edges: Array<RootQueryToLessonConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Lesson>;
  /** Information about pagination in a connection. */
  pageInfo: RootQueryToLessonConnectionPageInfo;
};

/** An edge in a connection */
export type RootQueryToLessonConnectionEdge = Edge & LessonConnectionEdge & {
...
/** Pagination metadata specific to &quot;RootQueryToLessonConnection&quot; collections. Provides cursors and flags for navigating through sets of RootQueryToLessonConnection Nodes. */
export type RootQueryToLessonConnectionPageInfo = LessonConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'RootQueryToLessonConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Provides access to fields of the &quot;CourseId&quot; ACF Field Group via the &quot;courseId&quot; field */
export type WithAcfCourseId = {
  /** Fields of the CourseId ACF Field Group */
  courseId?: Maybe<CourseId>;
};

/** Provides access to fields of the &quot;PageComponents&quot; ACF Field Group via the &quot;pageComponents&quot; field */
export type WithAcfPageComponents = {
  /** Fields of the PageComponents ACF Field Group */
  pageComponents?: Maybe<PageComponents>;
};
...
export type LessonFragment = { __typename?: 'RootQuery', lessons?: { __typename?: 'RootQueryToLessonConnection', nodes: Array<{ __typename?: 'Lesson', title?: string | null, slug?: string | null, date?: string | null, content?: string | null, contentType?: { __typename?: 'ContentNodeToContentTypeConnectionEdge', node: { __typename?: 'ContentType', description?: string | null } } | null, featuredImage?: { __typename?: 'NodeWithFeaturedImageToMediaItemConnectionEdge', node: { __typename?: 'MediaItem', mediaItemUrl?: string | null } } | null, lessonCategories?: { __typename?: 'LessonToLessonCategoryConnection', nodes: Array<{ __typename?: 'LessonCategory', name?: string | null }> } | null }> } | null };

export type GetAllLessonQueryVariables = Exact<{ [key: string]: never; }>;


export type GetAllLessonQuery = { __typename?: 'RootQuery', lessons?: { __typename?: 'RootQueryToLessonConnection', nodes: Array<{ __typename?: 'Lesson', title?: string | null, slug?: string | null, date?: string | null, content?: string | null, contentType?: { __typename?: 'ContentNodeToContentTypeConnectionEdge', node: { __typename?: 'ContentType', description?: string | null } } | null, featuredImage?: { __typename?: 'NodeWithFeaturedImageToMediaItemConnectionEdge', node: { __typename?: 'MediaItem', mediaItemUrl?: string | null } } | null, lessonCategories?: { __typename?: 'LessonToLessonCategoryConnection', nodes: Array<{ __typename?: 'LessonCategory', name?: string | null }> } | null }> } | null };
...
export type GetPageQuery = { __typename?: 'RootQuery', page?: { __typename?: 'Page', title?: string | null, uri?: string | null, template?: { __typename: 'DefaultTemplate', templateName?: string | null } | { __typename?: 'Template_PageNoTitle' } | null, pageComponents?: { __typename?: 'PageComponents', pageComponents?: Array<{ __typename: 'PageComponentsPageComponentsBannerHomepageLayout', bannerHomepage?: { __typename?: 'PageComponentsPageComponentsBannerHomepage', title?: string | null, description?: string | null, image?: { __typename?: 'AcfMediaItemConnectionEdge', node: { __typename?: 'MediaItem', mediaItemUrl?: string | null, altText?: string | null, mediaDetails?: { __typename?: 'MediaDetails', width?: number | null, height?: number | null } | null } } | null, button?: { __typename?: 'PageComponentCloneFieldsBannerHomepageButton', label?: string | null, link?: string | null } | null } | null } | { __typename: 'PageComponentsPageComponentsLessonSectionLayout', lesson?: { __typename?: 'PageComponentsPageComponentsLesson', title?: string | null, description?: string | null } | null } | null> | null } | null } | null };

export type HomePageBannerFragment = { __typename?: 'PageComponentsPageComponentsBannerHomepageLayout', bannerHomepage?: { __typename?: 'PageComponentsPageComponentsBannerHomepage', title?: string | null, description?: string | null, image?: { __typename?: 'AcfMediaItemConnectionEdge', node: { __typename?: 'MediaItem', mediaItemUrl?: string | null, altText?: string | null, mediaDetails?: { __typename?: 'MediaDetails', width?: number | null, height?: number | null } | null } } | null, button?: { __typename?: 'PageComponentCloneFieldsBannerHomepageButton', label?: string | null, link?: string | null } | null } | null };

export type LessonSectionFragment = { __typename?: 'PageComponentsPageComponentsLessonSectionLayout', lesson?: { __typename?: 'PageComponentsPageComponentsLesson', title?: string | null, description?: string | null } | null };

export type ImageFragment = { __typename?: 'AcfMediaItemConnectionEdge', node: { __typename?: 'MediaItem', mediaItemUrl?: string | null, altText?: string | null, mediaDetails?: { __typename?: 'MediaDetails', width?: number | null, height?: number | null } | null } };

export type GetPageUrisQueryVariables = Exact<{ [key: string]: never; }>;


export type GetPageUrisQuery = { __typename?: 'RootQuery', pages?: { __typename?: 'RootQueryToPageConnection', nodes: Array<{ __typename?: 'Page', uri?: string | null }> } | null };
...
export const ImageFragmentDoc = gql`
  ...
  node {
    ...
    `;
export const HomePageBannerFragmentDoc = gql`
  ...
  bannerHomepage {
    ...
    ${ImageFragmentDoc}`;
export const LessonSectionFragmentDoc = gql`
  ...
  lesson {
    ...
    `;
export const GetAllLessonDocument = gql`
    query GetAllLesson {
  ...Lesson
}
    ${LessonFragmentDoc}`;
export const GetPageDocument = gql`
  ...
  page(id: $uri, idType: URI) {
    ...
    ${HomePageBannerFragmentDoc}
${LessonSectionFragmentDoc}`;
export const GetPageUrisDocument = gql`
    query GetPageUris {
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    GetAllLesson(variables?: GetAllLessonQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetAllLessonQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetAllLessonQuery>(GetAllLessonDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetAllLesson', 'query', variables);
    },
    ...
    GetPageUris(variables?: GetPageUrisQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetPageUrisQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetPageUrisQuery>(GetPageUrisDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetPageUris', 'query', variables);
    }
  };
}
